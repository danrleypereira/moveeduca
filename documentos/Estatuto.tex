...
\textbf{Membro(a) Fundador(a) e Presidente -- Israel Carvalho}, [NACIONALIDADE], [ESTADO CIVIL], [PROFISSÃO], portador(a) do RG nº [RG], inscrito(a) no CPF sob nº [CPF], residente e domiciliado(a) em [ENDEREÇO COMPLETO], e-mail [E-MAIL], telefone [TELEFONE]. Assinatura: \rule{6cm}{0.4pt}

\vspace{1em}

\textbf{Membro(a) Fundador(a) e Vice-Presidente -- Prof. Dr. Sebastião Carneiro}, [NACIONALIDADE], [ESTADO CIVIL], Professor (Doutor em Educação para a Ciência -- UnB), portador(a) do RG nº [RG], inscrito(a) no CPF sob nº [CPF], residente e domiciliado(a) em [ENDEREÇO COMPLETO], e-mail [E-MAIL], telefone [TELEFONE]. Assinatura: \rule{6cm}{0.4pt}

\vspace{1em}

\textbf{Membro(a) Fundador(a) e Diretor(a) Financeiro(a) -- Danrley Pereira}, [NACIONALIDADE], [ESTADO CIVIL], [PROFISSÃO], portador(a) do RG nº [RG], inscrito(a) no CPF sob nº [CPF], residente e domiciliado(a) em [ENDEREÇO COMPLETO], e-mail [E-MAIL], telefone [TELEFONE]. Assinatura: \rule{6cm}{0.4pt}

\vspace{1em}

\textbf{Membro(a) Fundador(a) e Secretário(a)-Geral -- Polyana Cunha}, [NACIONALIDADE], [ESTADO CIVIL], Cientista da Computação, portador(a) do RG nº [RG], inscrito(a) no CPF sob nº [CPF], residente e domiciliado(a) em [ENDEREÇO COMPLETO], e-mail [E-MAIL], telefone [TELEFONE]. Assinatura: \rule{6cm}{0.4pt}

\textbf{2. Conselho de Administração}

\textbf{Membro(a) Fundador(a) e Conselheiro(a) de Administração -- Prof. Ms.sc. Marília Pinheiro}, [NACIONALIDADE], [ESTADO CIVIL], Professora de Biologia e Doutoranda em Bioética (UnB), portador(a) do RG nº [RG], inscrito(a) no CPF sob nº [CPF], residente e domiciliado(a) em [ENDEREÇO COMPLETO], e-mail [E-MAIL], telefone [TELEFONE]. Assinatura: \rule{6cm}{0.4pt}

\vspace{1em}

\textbf{Membro(a) Fundador(a) e Conselheiro(a) de Administração -- Prof. Dra. Kerlla Luz}, [NACIONALIDADE], [ESTADO CIVIL], Professora (Doutora em Engenharia Elétrica -- UnB), portador(a) do RG nº [RG], inscrito(a) no CPF sob nº [CPF], residente e domiciliado(a) em [ENDEREÇO COMPLETO], e-mail [E-MAIL], telefone [TELEFONE]. Assinatura: \rule{6cm}{0.4pt}

\vspace{1em}

\textbf{Membro(a) Fundador(a) e Conselheiro(a) de Administração -- Paulo Murilo}, [NACIONALIDADE], [ESTADO CIVIL], Programador e Professor de Informática, portador(a) do RG nº [RG], inscrito(a) no CPF sob nº [CPF], residente e domiciliado(a) em [ENDEREÇO COMPLETO], e-mail [E-MAIL], telefone [TELEFONE]. Assinatura: \rule{6cm}{0.4pt}

\textbf{3. Conselho Fiscal}

\textbf{Membro(a) Fundador(a) e Conselheiro(a) Fiscal -- Aulus Diniz}, [NACIONALIDADE], [ESTADO CIVIL], Bacharel em Engenharia de Software, portador(a) do RG nº [RG], inscrito(a) no CPF sob nº [CPF], residente e domiciliado(a) em [ENDEREÇO COMPLETO], e-mail [E-MAIL], telefone [TELEFONE]. Assinatura: \rule{6cm}{0.4pt}

\vspace{1em}

\textbf{Membro(a) Fundador(a) e Conselheiro(a) Fiscal -- Carlos Donizete}, [NACIONALIDADE], [ESTADO CIVIL], Educador, portador(a) do RG nº [RG], inscrito(a) no CPF sob nº [CPF], residente e domiciliado(a) em [ENDEREÇO COMPLETO], e-mail [E-MAIL], telefone [TELEFONE]. Assinatura: \rule{6cm}{0.4pt}

\vspace{1em}

\textbf{Membro(a) Fundador(a) e Conselheiro(a) Fiscal -- Ariana}, [NACIONALIDADE], [ESTADO CIVIL], Administradora, portador(a) do RG nº [RG], inscrito(a) no CPF sob nº [CPF], residente e domiciliado(a) em [ENDEREÇO COMPLETO], e-mail [E-MAIL], telefone [TELEFONE]. Assinatura: \rule{6cm}{0.4pt}
